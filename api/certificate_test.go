...
func (noOpLogger) Log(keyvals ...interface{}) error {
...
func TestAPICertificateMetadataHandler(t *testing.T) {
	...
	expected := `[{"domain":"testfgx.example.com","issuer":"pebble","bundle":false,"expires":"","fingerprint":"","owner":"testuser","csr":"","labels":"","encryption":"","serial":""}]`
	if rr.Body.String() != expected {
		t.Errorf("handler returned unexpected body: got %v want %v", rr.Body.String(), expected)
	}
}
